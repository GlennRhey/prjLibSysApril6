...
<script>
    ...
    function initializeAutocomplete() {
        var searchInput = document.getElementById('<%= txtSearchBooks.ClientID %>');
    ...
    function fetchSearchSuggestions(query) {
        // Use local page method for book suggestions
        fetch('MemberBorrowBooks.aspx/GetSearchSuggestions', {
            method: 'POST',
