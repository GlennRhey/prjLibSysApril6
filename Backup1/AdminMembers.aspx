...
<script>
    ...
    function initializeAutocomplete() {
        var searchInput = document.getElementById('<%= txtSearchMember.ClientID %>');
    ...
    function selectSuggestion(value) {
        ...
        // Trigger search
        __doPostBack('<%= btnSearchMember.UniqueID %>', '');
    }

    function fetchSearchSuggestions(query) {
        // Use real web service for member suggestions
        fetch('SearchSuggestions.asmx/GetMemberSuggestions', {
            method: 'POST',
