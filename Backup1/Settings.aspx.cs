    ...
    public partial class Settings : System.Web.UI.Page
    {
        ...
        void LoadPolicy()
        {
            gvPolicy.DataSource = DatabaseHelper.ExecuteQuery(
                "SELECT SettingID, MemberType, SettingKey, SettingValue FROM tblBorrowPolicies ORDER BY MemberType, SettingKey",
                null);
            gvPolicy.DataBind();
        }
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrWhiteSpace(txtEditValue.Text))
            {
                ...
                ScriptManager.RegisterStartupScript(this, GetType(), "ReopenModal", "$('#editModal').modal('show');", true);
                return;
            }
            ...
            ScriptManager.RegisterStartupScript(this, GetType(),
                "CloseModal", "$('#editModal').modal('hide');", true);
        }
