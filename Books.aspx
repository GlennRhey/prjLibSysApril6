...
<form id="form1" runat="server">
    ...
    <%-- Borrow Settings Modal (View Only) --%>
            ...
            <div class="modal-content" style="border:none;border-radius:10px;overflow:hidden;">
                ...
                <div class="modal-body" style="padding:20px 24px;">
                        ...
                        <div class="row g-3">
                            <div class="col-6">
                                ...
                                <div class="settings-input-wrap">
                                    <input type="number" id="inputStuMax" class="settings-num-input" readonly style="background-color:#e9ecef;cursor:default;" />
                            ...
                            <div class="col-6">
                                ...
                                <div class="settings-input-wrap">
                                    <input type="number" id="inputStuDays" class="settings-num-input" readonly style="background-color:#e9ecef;cursor:default;" />
                    ...
                    <div class="settings-section" style="margin-bottom:0;">
                        ...
                        <div class="row g-3">
                            <div class="col-6">
                                <p class="settings-input-label mb-1">Max Books to Borrow</p>
                                <div class="settings-input-wrap">
                                    <input type="number" id="inputTchMax" class="settings-num-input" readonly style="background-color:#e9ecef;cursor:default;" />
                                    <span class="unit-tag">books</span>
                                </div>
                            </div>
                            <div class="col-6">
                                <p class="settings-input-label mb-1">Borrow Duration</p>
                                <div class="settings-input-wrap">
                                    <input type="number" id="inputTchDays" class="settings-num-input" readonly style="background-color:#e9ecef;cursor:default;" />
                                    <span class="unit-tag">days</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="alert alert-info mt-3 mb-0" style="font-size:.85rem;">
                        ...
                        To change borrow policy settings, go to the <strong>Settings</strong> page.
                    </div>
                </div>
                <div class="modal-footer" style="background:#f0f4ff;border-top:1px solid #c5cae9;">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                </div>
            </div>
        </div>
    ...
    function showSuggestions(suggestions) {
        ...
        if (suggestions.length === 0) {
            ...
            suggestions.forEach(function(suggestion) {
                ...
                item.innerHTML = suggestion.DisplayText || suggestion.displayText;
                item.addEventListener('click', function() {
                    selectSuggestion(suggestion.Value || suggestion.value);
                });
